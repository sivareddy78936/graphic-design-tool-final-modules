...
import "./AboutApp.css";
import StarImage from "../../../../assets/AccountCenter/star.svg";
...
export default function AboutApp() {
  ...
  useEffect(() => {
    axios.get("http://13.201.87.205:5050/api/about")
      .then((res) => {
        if (res?.data) {
  ...
  const openLegalPage = (url) => {
    window.open(`http://13.201.87.205:5050${url}`, '_blank');
  };
  ...
  <a
  href="http://13.201.87.205:5050/api/about/website"
  target="_blank"
