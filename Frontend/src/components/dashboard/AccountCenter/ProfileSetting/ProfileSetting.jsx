...
import Phone from "../../../../assets/AccountCenter/phone.svg"
import people from "../../../../assets/AccountCenter/idpeople.svg"
import Email from "../../../../assets/AccountCenter/email.svg"
import OTP from "../../../../assets/AccountCenter/otp.svg"
import darkOTP from "../../../../assets/AccountCenter/darkotp.svg"
import Darkphone from "../../../../assets/AccountCenter/darkphone.svg"
import Darkpeople from "../../../../assets/AccountCenter/darkidpeople.svg"
import DarkEmail from "../../../../assets/AccountCenter/darkemail.svg"
import DarkIdPeople from "../../../../assets/AccountCenter/darkidpeople.svg"
import DarkPencil from "../../../../assets/AccountCenter/darkpencil.svg"
import Alert from "../../../../assets/AccountCenter/alertdisconnect.svg"
...
import Pencil from "../../../../assets/AccountCenter/pencil.svg"
import Google from "../../../../assets/AccountCenter/google.svg"
import Trash from "../../../../assets/AccountCenter/trash.svg"
import Vector from "../../../../assets/AccountCenter/vector.svg"
import Disconnect from "../../../../assets/AccountCenter/disconnect.svg"
import DeleteTrash from "../../../../assets/AccountCenter/deleteaccount_trash.svg"
import Star from "../../../../assets/AccountCenter/star.svg"
import Darktrash from "../../../../assets/AccountCenter/darktrash.svg"
...
const ProfileSetting = () => {
  ...
  const fetchProfile = async () => {
    try {
      const res = await axios.get(
        "http://13.201.87.205:5050/api/profile-settings",
        {
          headers: {
  ...
  const updateName = async () => {
    try {
      const res = await axios.put("http://13.201.87.205:5050/api/profile-settings",
  ...
  const sendOldPhoneOtp = async () => {
    try {
      await axios.post(
        "http://13.201.87.205:5050/api/auth/send-otp",
        { phone }, // OLD phone
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const verifyOldPhoneOtp = async () => {
    ...
    try {
      await axios.post(
        "http://13.201.87.205:5050/api/profile-settings/verify-old-phone",
        { otp: otpValue },
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const verifyOldEmailOtp = async () => {
    ...
    try {
      await axios.post(
        "http://13.201.87.205:5050/api/profile-settings/verify-old-email",
        { otp: otpValue },
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const sendOtp = async (type) => {
    try {
      ...
      const res = await axios.post(
        "http://13.201.87.205:5050/api/profile-settings/request-update",
        payload,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const verifyOtp = async () => {
    ...
    try {
      await axios.post(
        "http://13.201.87.205:5050/api/profile-settings/verify-update",
        { otp: otpValue },
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const disconnectGoogle = async () => {
    try {
      await axios.delete("http://13.201.87.205:5050/api/profile-settings");
                    ...
                    <div className="google-disconnect-overlay">
                      <div className="google-container">
                        ...
                        <p className="google-disconnect-message">
                          ...
                          <b>{email}</b>? You won’t be able to use it for sign in
