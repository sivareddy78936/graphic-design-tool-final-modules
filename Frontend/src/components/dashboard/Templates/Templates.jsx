...
function Templates() {
    ...
    const fetchData = async () => {
      ...
      try {
        const res = await axios.get(
          "http://13.201.87.205:5050/api/templates",
        );
  ...
  // useEffect(() => {
  //   axios.get("http://13.201.87.205:5050/api/templates").then((res)=>{
  ...
  //   try {
  //     const res = await axios.get("http://13.201.87.205:5050/api/templates");
  ...
  const handleSearch = async (query) => {
    try {
      ...
      const res = await axios.get(
        `http://13.201.87.205:5050/api/templates/search?search=${query}`
      );
  ...
  const handleFilter = async (category) => {
    ...
    try {
      ...
      const res = await axios.get(
        ...
        `http://13.201.87.205:5050/api/templates/filter?category=${category}`
